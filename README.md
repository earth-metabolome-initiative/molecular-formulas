...
It validates correctly against **123,455,852** compounds from PubChem (99.46% mass accuracy, **~475 ns/compound**) and is **fuzzed** for over **1 billion iterations** (see the [`fuzz`](fuzz) crate) to ensure we handle all sorts of textual input.
...
- **Composition Analysis**:
  - **Stoichiometry**: Get counts of specific elements.
...
- **Integration**: Optional features for `serde` serialization.
...
The library supports isotopes using superscript notation (e.g., `¹³C`).
...
// 13C-labeled Methane (using superscript ¹³C)
...
// The mass difference should be approx 1.00335 Da (Mass of 13C - Mass of 12C)
