...
fn test_ethyl_compound() {
    ...
    assert_eq!(formula.element_count(elements_rs::Element::C), Some(4));
    assert_eq!(formula.element_count(elements_rs::Element::H), Some(10));
    assert_eq!(formula.element_count(elements_rs::Element::O), Some(1));
}
...
fn test_phenyl_compounds() {
    ...
    assert_eq!(phenol.element_count(elements_rs::Element::C), Some(6));
    assert_eq!(phenol.element_count(elements_rs::Element::H), Some(6));
    assert_eq!(phenol.element_count(elements_rs::Element::O), Some(1));

    // PhCOOH -> C6H5COOH -> C7H6O2
    let benzoic_acid: MolecularFormula = MolecularFormula::from_str("PhCOOH").unwrap();
    assert_eq!(benzoic_acid.element_count(elements_rs::Element::C), Some(7));
    assert_eq!(benzoic_acid.element_count(elements_rs::Element::H), Some(6));
    assert_eq!(benzoic_acid.element_count(elements_rs::Element::O), Some(2));
}
...
fn test_benzyl_compounds() {
    ...
    assert_eq!(benzyl_bromide.element_count(elements_rs::Element::C), Some(7));
    assert_eq!(benzyl_bromide.element_count(elements_rs::Element::H), Some(7));
    assert_eq!(benzyl_bromide.element_count(elements_rs::Element::Br), Some(1));
}
...
fn test_cyclohexyl() {
    ...
    assert_eq!(cyclohexanol.element_count(elements_rs::Element::C), Some(6));
    assert_eq!(cyclohexanol.element_count(elements_rs::Element::H), Some(12));
    assert_eq!(cyclohexanol.element_count(elements_rs::Element::O), Some(1));
}
...
fn test_cyclopentadienyl() {
    ...
    assert_eq!(ferrocene.element_count(elements_rs::Element::C), Some(10));
    assert_eq!(ferrocene.element_count(elements_rs::Element::H), Some(10));
    assert_eq!(ferrocene.element_count(elements_rs::Element::Fe), Some(1));
